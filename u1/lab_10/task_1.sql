...
-- Select non parallel
SELECT COUNT(*) FROM CALENDAR WHERE day_name = '¬ÚÓÌËÍ' 
AND calendar_quarter_number in (1,2,3) 
AND calendar_month_number BETWEEN 1 AND 11;

-- Select parallel
SELECT /*+ parallel(CALENDAR, 4) */ COUNT(*) FROM CALENDAR WHERE day_name = '¬ÚÓÌËÍ' 
AND calendar_quarter_number in (1,2,3) 
AND calendar_month_number BETWEEN 1 AND 11;

-- Delete non parallel
DELETE FROM CALENDAR
WHERE day_name IN ('œÓÌÂ‰ÂÎ¸ÌËÍ', '¬ÚÓÌËÍ');
